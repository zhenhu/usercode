        ...
        for line in infile.readlines():
            ...
            # Change number of jobs to something sensible
                ...
                if runmode == "PAT":
                    ...
                    print eventsPerJob,self.sampleNumEvents,nJobs
                    # Limit to 1000 jobs
                    if nJobs > 1000: nJobs=1000
                    if nJobs==0: nJobs=1
                    print nJobs
                elif runmode == "TREE":
                    nJobs=50
...
#     os.system("lumiCalc2.py recorded -i "+jsonFile+" --hltpath "+trigger+" -o "+output)
    ...
    # Pixel lumi calc now available for 2012 data (2/9/2013)
    print "Running pixelLumiCalc.py for trigger :",trigger," and json file : ",jsonFile
    os.system("pixelLumiCalc.py recorded -i "+jsonFile+" --hltpath "+trigger+" -o "+output)
...
def getPUInfo(workdir,analysisSample):
    ...
    runPileUpCalc(workdir,workdir+"/crabDir/res/lumiSummary.json ",puJson,workdir+"/pileup_p5.root",minBiasXSec*1.06)
    runPileUpCalc(workdir,workdir+"/crabDir/res/lumiSummary.json ",puJson,workdir+"/pileup_m5.root",minBiasXSec*0.94)
