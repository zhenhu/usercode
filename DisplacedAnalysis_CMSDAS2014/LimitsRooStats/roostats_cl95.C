...
public:
  ...
  LimitResult(const LimitResult & other):
    ...
    _low997(other._low997),
    _high997(other._high997),
  ...
  Double_t GetThreeSigmaLowRange(){return _low997;};
  Double_t GetThreeSigmaHighRange(){return _high997;};
...
LimitResult CL95Calc::clm( Double_t ilum, Double_t slum,
  ...
  Double_t b997[2] = {0.0, 0.0}; // 3-sigma expected band
  ...
  Double_t _prob[6]; // array with quantile boundaries
  _prob[0] = 0.00135;
  _prob[1] = 0.021;
  _prob[2] = 0.159;
  _prob[3] = 0.841;
  ...
  Double_t _quantiles[6]; // array for the results

  TMath::Quantiles(nit, 6, &pe[0], _quantiles, _prob); // evaluate quantiles
  ...
  _result._low997 = b997[0];
  _result._high997 = b997[1];
