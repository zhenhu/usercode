# Note: This doesn't work when sourced and I don't know why. It works fine if you paste
# the commands into the shell yourself. Very confusing.
...
#source /afs/cern.ch/sw/lcg/app/releases/ROOT/5.32.01/x86_64-slc5-gcc43-opt/root/bin/thisroot.csh
...
cd /afs/cern.ch/user/p/plujan/public/displacedfermions/trunk/LimitsRooStats
