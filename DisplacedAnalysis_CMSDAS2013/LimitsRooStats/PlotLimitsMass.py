...
FileDir = LeptonType + "BayesianWinterMassSingleRes"
...
gest.SetTitle("CMS Preliminary    #sqrt{s} = 7 TeV    L = "+lumi+" fb^{-1}")
c.Print("limits"+FileInfix+"Events"+LeptonType+"ExpPAS.png")
c.Print("limits"+FileInfix+"Events"+LeptonType+"ExpPAS.pdf")

gest.SetTitle("CMS    #sqrt{s} = 7 TeV    L = "+lumi+" fb^{-1}")
