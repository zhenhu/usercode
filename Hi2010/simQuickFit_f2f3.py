...
from ROOT import readData,computeRatio,computeRatioError,buildPdf,\
     mmin,mmax,\
     RooWorkspace,RooFit, RooStats,TCanvas,kRed,kGreen,kDashed,buildSimPdf,RooArgSet,\
     RooRealVar,RooMsgService, TMath, TFile

RooMsgService.instance().setGlobalKillBelow(RooFit.WARNING)

hidatafile = '/home/zhenhu/HI2011/dimuonTree_full_trkRot.root'
...
resultFile = TFile("lastSimFit0100.root", "recreate")
fr.Write("nll")
resultFile.Close()
