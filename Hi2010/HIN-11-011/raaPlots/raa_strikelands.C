{
	ifstream in_1Seta1, in_1Seta2, in_1Seta3, in_2Seta1, in_2Seta2, in_2Seta3;
	in_1Seta1.open("Y1sFull-potb-eta1-npart.dat");
	in_1Seta2.open("Y1sFull-potb-eta2-npart.dat");
	in_1Seta3.open("Y1sFull-potb-eta3-npart.dat");
	in_2Seta1.open("Y2sFull-potb-eta1-npart.dat");
	in_2Seta2.open("Y2sFull-potb-eta2-npart.dat");
	in_2Seta3.open("Y2sFull-potb-eta3-npart.dat");

	float Npart[101];
	float Raa_Y1Seta1[101], Raa_Y1Seta2[101], Raa_Y1Seta3[101], Raa_Y2Seta1[101], Raa_Y2Seta2[101], Raa_Y2Seta3[101];
	for (int i=0; i<101; i++) {
		in_1Seta1 >> Npart[i] >> Raa_Y1Seta1[i];
		in_1Seta2 >> Npart[i] >> Raa_Y1Seta2[i];
		in_1Seta3 >> Npart[i] >> Raa_Y1Seta3[i];
		in_2Seta1 >> Npart[i] >> Raa_Y2Seta1[i];
		in_2Seta2 >> Npart[i] >> Raa_Y2Seta2[i];
		in_2Seta3 >> Npart[i] >> Raa_Y2Seta3[i];
	}


	pgStrickland_Ups1S_Npart1 = new TGraph(101, Npart, Raa_Y1Seta1);
	pgStrickland_Ups1S_Npart2 = new TGraph(101, Npart, Raa_Y1Seta2);
	pgStrickland_Ups1S_Npart3 = new TGraph(101, Npart, Raa_Y1Seta3);

	pgStrickland_Ups2S_Npart1 = new TGraph(101, Npart, Raa_Y2Seta1);
	pgStrickland_Ups2S_Npart2 = new TGraph(101, Npart, Raa_Y2Seta2); 
	pgStrickland_Ups2S_Npart3 = new TGraph(101, Npart, Raa_Y2Seta3);

	pgStrickland_Ups1S_Npart1->SetLineWidth(2);
	pgStrickland_Ups1S_Npart2->SetLineWidth(2);
	pgStrickland_Ups1S_Npart3->SetLineWidth(2);

	pgStrickland_Ups1S_Npart1->SetLineColor(kRed);
	pgStrickland_Ups1S_Npart2->SetLineColor(kRed);
	pgStrickland_Ups1S_Npart3->SetLineColor(kRed);

	pgStrickland_Ups1S_Npart1->SetLineStyle(1);
	pgStrickland_Ups1S_Npart2->SetLineStyle(2);
	pgStrickland_Ups1S_Npart3->SetLineStyle(3);

	pgStrickland_Ups2S_Npart1->SetLineWidth(2);
	pgStrickland_Ups2S_Npart2->SetLineWidth(2);
	pgStrickland_Ups2S_Npart3->SetLineWidth(2);

	pgStrickland_Ups2S_Npart1->SetLineStyle(1);
	pgStrickland_Ups2S_Npart2->SetLineStyle(2);
	pgStrickland_Ups2S_Npart3->SetLineStyle(3);
	...
	pgStrickland_Ups1S_Npart1->Draw("C");
	pgStrickland_Ups1S_Npart2->Draw("C");
	pgStrickland_Ups1S_Npart3->Draw("C");

	pgStrickland_Ups2S_Npart1->Draw("C");
	pgStrickland_Ups2S_Npart2->Draw("C");
	pgStrickland_Ups2S_Npart3->Draw("C");
	...
	leg3a = new TLegend(0.53,0.43,0.99,0.67);
	...
	leg3a->SetHeader("M. Strickland"); // (arXiv:1106.2571)
	leg3a->AddEntry(pgStrickland_Ups1S_Npart3,"#varUpsilon(1S), 4#pi#eta/s = 3","L");
	leg3a->AddEntry(pgStrickland_Ups1S_Npart2,"#varUpsilon(1S), 4#pi#eta/s = 2","L");
	leg3a->AddEntry(pgStrickland_Ups1S_Npart1,"#varUpsilon(1S), 4#pi#eta/s = 1","L");
	leg3a->AddEntry(pgStrickland_Ups2S_Npart3,"#varUpsilon(2S), 4#pi#eta/s = 3","L");
	leg3a->AddEntry(pgStrickland_Ups2S_Npart2,"#varUpsilon(2S), 4#pi#eta/s = 2","L");
	leg3a->AddEntry(pgStrickland_Ups2S_Npart1,"#varUpsilon(2S), 4#pi#eta/s = 1","L");
	leg3a->Draw();

	c1->SaveAs("upsilon_RAA_Strickland.gif");
	c1->SaveAs("upsilon_RAA_Strickland.pdf");
}
