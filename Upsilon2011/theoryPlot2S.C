void theoryPlot2S(){
  ...
  TFile cmsFile("xsection_2s_y0_40.root");      //  40pb
  //TFile cmsFile("xsection_2s_rap_0_2.root");  //  3pb
...
//  cmsdata1->Draw("Psame");
  ...
  TLatex latex2;
  latex2.DrawLatex(2,0.0003,"#Upsilon(2S)");
...
//normalize
  ...
  c2->Print("theoryPlot2S_cascade.gif");
  c2->Print("theoryPlot2S_cascade.eps");
  c2->Print("theoryPlot2S_cascade.pdf");
  ...
  latex2.DrawLatex(2,0.0015,"#Upsilon(2S)");
  latex3.DrawLatex(2,0.0004 , "#sqrt{s} = 7 TeV, L = 39 pb^{ -1}");
  c2->Print("theoryPlot2S_CEM.gif");
  c2->Print("theoryPlot2S_CEM.eps");
  c2->Print("theoryPlot2S_CEM.pdf");
