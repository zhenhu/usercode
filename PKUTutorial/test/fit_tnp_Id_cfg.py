...
#      ),
      ...
      NumBkgPass        = cms.untracked.vdouble( 4000.0,0.0,10000.0 ),#-10.0 -> 0.0    
...
#    ReadFromFiles = [ 'histo_output_HltFromUpsTm_test.root' ],
#    FitFileName   =     'fit_result_HltFromUpsTm_test1.root'  ,
#    Var2BinBoundaries   = cms.untracked.vdouble( -2.1,-1.2,0.0,1.2,2.1),
#)
